...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI7314_bli_listarproductos")
})
public class BLI7314_bli_listarproductos implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI7314_bli_listarproductos.class);
  ...
  public void execute(DynamicRequest dynamicRequest) {
    ...
    try {
      ...
      mapperSp1.addMapper(Producto.PRECIO, 4, BLIUtils.getCurrencyFormat());
