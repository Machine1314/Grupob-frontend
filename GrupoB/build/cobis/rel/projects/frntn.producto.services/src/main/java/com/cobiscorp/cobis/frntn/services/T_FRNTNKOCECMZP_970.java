/*
 * Archivo: T_FRNTNKOCECMZP_970.java
 * Fecha: 2021-04-23T23:10:58Z
 *
 ...
 */
package com.cobiscorp.cobis.frntn.services;
 ...
 * T_FRNTNKOCECMZP_970 - Pantalla productos 
 *
 */
@Path("/FRNTN/FCTRC/T_FRNTNKOCECMZP_970")
@Component
@Service({T_FRNTNKOCECMZP_970.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FRNTN)(task.submodule=FCTRC)(task.id=T_FRNTNKOCECMZP_970)(task.version=1.0.0))")
,@Reference(name="VW_PANTALLAPD_535", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PANTALLAPD_535)(view.version=1.0.0))")
,@Reference (name="QV_WD27_ZDC17",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_WD27_ZDC17)")
,@Reference(name="Q_PRODCTTO_OE27",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_PRODCTTO_OE27)(query.version=1.0.0))")
...
public class T_FRNTNKOCECMZP_970 {
