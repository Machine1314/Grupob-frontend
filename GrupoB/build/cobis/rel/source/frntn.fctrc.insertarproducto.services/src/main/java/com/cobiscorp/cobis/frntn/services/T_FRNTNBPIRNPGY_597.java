/*
 * Archivo: T_FRNTNBPIRNPGY_597.java
 * Fecha: 2021-04-23T23:12:57Z
 *
 ...
 * T_FRNTNBPIRNPGY_597 - Insertar Producto 
 *
 */
@Path("/FRNTN/FCTRC/T_FRNTNBPIRNPGY_597")
@Component
@Service({T_FRNTNBPIRNPGY_597.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FRNTN)(task.submodule=FCTRC)(task.id=T_FRNTNBPIRNPGY_597)(task.version=1.0.0))")
,@Reference(name="VW_INSERTAROO_778", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_INSERTAROO_778)(view.version=1.0.0))")
...
public class T_FRNTNBPIRNPGY_597 {
