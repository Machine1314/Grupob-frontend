...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI1975_bli_eliminarproducto")
})
public class BLI1975_bli_eliminarproducto implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI1975_bli_eliminarproducto.class);
